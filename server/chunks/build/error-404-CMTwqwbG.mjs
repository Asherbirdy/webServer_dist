...
import { u as useHead } from './vue.65b7bcda-DxGoQ5II.mjs';
import 'node:http';
import 'node:https';
import 'node:zlib';
import 'node:stream';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs_1(vueExports.mergeProps({ class: "font-sans antialiased bg-white dark:bg-black text-black dark:text-white grid min-h-screen place-content-center overflow-hidden" }, _attrs))} data-v-f27d9334><div class="fixed left-0 right-0 spotlight z-10" data-v-f27d9334></div><div class="max-w-520px text-center z-20" data-v-f27d9334><h1 class="text-8xl sm:text-10xl font-medium mb-8" data-v-f27d9334>${ssrInterpolate_1(__props.statusCode)}</h1><p class="text-xl px-8 sm:px-0 sm:text-4xl font-light mb-16 leading-tight" data-v-f27d9334>${ssrInterpolate_1(__props.description)}</p><div class="w-full flex items-center justify-center" data-v-f27d9334>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.13.0_@parcel+watcher@2.4.1_@types+node@22.5.0_eslint@8.57.0_ioredis@5.4.1_magicast@0.3_wduf5ecve5zkpzgvkhnz4xbmda/node_modules/nuxt/dist/app/components/error-404.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f27d9334"]]);

export { error404 as default };
//# sourceMappingURL=error-404-CMTwqwbG.mjs.map
