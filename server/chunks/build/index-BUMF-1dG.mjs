import { v as vueExports, f as ssrRenderComponent_1, e as ssrInterpolate_1, k as useSsrAdapter } from './server.mjs';
import 'node:http';
import 'node:https';
import 'node:zlib';
import 'node:stream';
  ...
  vNodes.forEach((vNode) => {
    ...
    if (typeof vNode !== "object") {
      if (typeof vNode === "string" || typeof vNode === "number") {
        result.push(vueExports.createTextVNode(String(vNode)));
      }
      return;
    }
    ...
    if (vNode.type === vueExports.Fragment) {
      ...
      if (vNode.type === vueExports.Comment && filterCommentNode)
        return;
      result.push(vNode);
    }
  });
...
function ensureValidVNode(vnodes) {
  return vnodes.some((child) => {
    if (!vueExports.isVNode(child)) {
      return true;
    }
    if (child.type === vueExports.Comment) {
      return false;
    }
    if (child.type === vueExports.Fragment && !ensureValidVNode(child.children)) {
      return false;
    }
    return true;
  }) ? vnodes : null;
...
function useMemo(getterOrOptions) {
  const computedValueRef = vueExports.computed(getterOrOptions);
  const valueRef = vueExports.ref(computedValueRef.value);
  vueExports.watch(computedValueRef, (value) => {
...
function isMounted() {
  const isMounted2 = vueExports.ref(false);
  return vueExports.readonly(isMounted2);
}
...
function useFormItem(props, {
  ...
  const NFormItem = vueExports.inject(formItemInjectionKey, null);
  vueExports.provide(formItemInjectionKey, null);
  const mergedSizeRef = vueExports.computed(mergedSize ? () => mergedSize(NFormItem) : () => {
    const {
      size
    } = props;
    if (size)
  ...
  const mergedDisabledRef = vueExports.computed(mergedDisabled ? () => mergedDisabled(NFormItem) : () => {
    const {
      disabled
    } = props;
    if (disabled !== void 0) {
  ...
  const mergedStatusRef = vueExports.computed(() => {
    const {
      status
    } = props;
    if (status)
...
function useTheme(resolveId, mountId, style2, defaultTheme, props, clsPrefixRef) {
  ...
  const NConfigProvider = vueExports.inject(configProviderInjectionKey, null);
  if (style2) {
    const mountStyle = () => {
  ...
  const mergedThemeRef = vueExports.computed(() => {
    var _a;
    const {
      theme: {
        common: selfCommon,
...
function useConfig(props = {}, options = {
  ...
  return {
    ...
    mergedBorderedRef: vueExports.computed(() => {
      var _a, _b;
      const {
        bordered
      } = props;
    ...
    mergedClsPrefixRef: NConfigProvider ? NConfigProvider.mergedClsPrefixRef : vueExports.shallowRef(defaultClsPrefix),
    namespaceRef: vueExports.computed(() => NConfigProvider === null || NConfigProvider === void 0 ? void 0 : NConfigProvider.mergedNamespaceRef.value)
  };
}
...
function useThemeClass(componentName, hashRef, cssVarsRef, props) {
  ...
  const mergedThemeHashRef = (_a = vueExports.inject(configProviderInjectionKey, null)) === null || _a === void 0 ? void 0 : _a.mergedThemeHashRef;
  const themeClassRef = vueExports.ref("");
  const ssrAdapter = useSsrAdapter();
  let renderCallback;
...
function useRtl(mountId, rtlStateRef, clsPrefixRef) {
  if (!rtlStateRef)
    return void 0;
  const ssrAdapter = useSsrAdapter();
  const componentRtlStateRef = vueExports.computed(() => {
    const {
      value: rtlState
    } = rtlStateRef;
    if (!rtlState) {
...
const NIconSwitchTransition = vueExports.defineComponent({
  name: "BaseIconSwitchTransition",
  setup(_, {
    slots
  }) {
    const isMountedRef = isMounted();
    return () => vueExports.h(vueExports.Transition, {
      name: "icon-switch-transition",
      appear: isMountedRef.value
    }, slots);
  }
});
const NFadeInExpandTransition = vueExports.defineComponent({
  ...
  setup(props, {
    ...
    return () => {
      ...
      const type = group ? vueExports.TransitionGroup : vueExports.Transition;
      const resolvedProps = {
      ...
      return vueExports.h(type, resolvedProps, slots);
    };
  }
});
const {
...
const style$3 = c([c("@keyframes rotator", `
 0% {
...
const NBaseLoading = vueExports.defineComponent({
  name: "BaseLoading",
  props: Object.assign({
    clsPrefix: {
      type: String,
  ...
  setup(props) {
    useStyle("-base-loading", style$3, vueExports.toRef(props, "clsPrefix"));
  },
  render() {
    const {
      clsPrefix,
    ...
    return vueExports.h("div", {
      ...
      role: "img",
      "aria-label": "loading"
    }, vueExports.h(NIconSwitchTransition, null, {
      default: () => this.show ? vueExports.h("div", {
        key: "icon",
      ...
      }, vueExports.h("g", null, vueExports.h("animateTransform", {
...
`);
const NBaseWave = vueExports.defineComponent({
  name: "BaseWave",
  props: {
    clsPrefix: {
      type: String,
  ...
  setup(props) {
    useStyle("-base-wave", style$2, vueExports.toRef(props, "clsPrefix"));
    const selfRef = vueExports.ref(null);
    const activeRef = vueExports.ref(false);
...
const Button = vueExports.defineComponent({
  name: "Button",
  props: buttonProps,
  setup(props) {
    const selfElRef = vueExports.ref(null);
    const waveElRef = vueExports.ref(null);
    const enterPressedRef = vueExports.ref(false);
    const showBorderRef = useMemo(() => {
      return !props.quaternary && !props.tertiary && !props.secondary && !props.text && (!props.color || props.ghost || props.dashed) && props.bordered;
    });
    const NButtonGroup = vueExports.inject(buttonGroupInjectionKey, {});
    const {
      mergedSizeRef
    } = useFormItem({}, {
      defaultSize: "medium",
    ...
    const mergedFocusableRef = vueExports.computed(() => {
    ...
    const themeRef = useTheme("Button", "-button", style$1, buttonLight, props, mergedClsPrefixRef);
    const rtlEnabledRef = useRtl("Button", mergedRtlRef, mergedClsPrefixRef);
    const cssVarsRef = vueExports.computed(() => {
    ...
    const themeClassHandle = inlineThemeDisabled ? useThemeClass("button", vueExports.computed(() => {
      let hash = "";
      const {
        dashed,
        type,
    ...
    return {
      ...
      handleKeyup,
      handleClick,
      customColorCssVars: vueExports.computed(() => {
        const {
          color
        } = props;
        if (!color)
  ...
  render() {
    ...
    const children = resolveWrappedSlot(this.$slots.default, (children2) => children2 && vueExports.h("span", {
      class: `${mergedClsPrefix}-button__content`
    }, children2));
    return vueExports.h(Component, {
      ref: "selfElRef",
      class: [
        this.themeClass,
    ...
    }, this.iconPlacement === "right" && children, vueExports.h(NFadeInExpandTransition, {
      width: true
    }, {
      default: () => resolveWrappedSlot(this.$slots.icon, (children2) => (this.loading || this.renderIcon || children2) && vueExports.h("span", {
        class: `${mergedClsPrefix}-button__icon`,
        style: {
          margin: isSlotEmpty(this.$slots.default) ? "0" : ""
        }
      }, vueExports.h(NIconSwitchTransition, null, {
        default: () => this.loading ? vueExports.h(NBaseLoading, {
    ...
    }), this.iconPlacement === "left" && children, !this.text ? vueExports.h(NBaseWave, {
      ref: "waveElRef",
      clsPrefix: mergedClsPrefix
    }) : null, this.showBorder ? vueExports.h("div", {
      "aria-hidden": true,
...
const NSpace = vueExports.defineComponent({
  name: "Space",
  props: spaceProps,
  setup(props) {
    const {
  ...
  render() {
    ...
    }, !wrapItem && (useGap || internalUseGap) ? children : children.map((child, index) => child.type === vueExports.Comment ? child : vueExports.h("div", {
      role: "none",
      class: itemClass,
      style: [itemStyle, {
        maxWidth: "100%"
...
const NText = vueExports.defineComponent({
  name: "Text",
  props: textProps,
  setup(props) {
    const {
    ...
    const themeClassHandle = inlineThemeDisabled ? useThemeClass("text", vueExports.computed(() => `${props.type[0]}${props.depth || ""}`), cssVarsRef, props) : void 0;
    return {
      mergedClsPrefix: mergedClsPrefixRef,
  ...
  render() {
    ...
    return this.code ? vueExports.h("code", {
      class: textClass,
      style: this.cssVars
    }, this.delete ? vueExports.h("del", null, children) : children) : this.delete ? vueExports.h("del", {
      class: textClass,
      style: this.cssVars
    }, children) : vueExports.h(this.compitableTag || "span", {
      class: textClass,
      style: this.cssVars
    }, children);
  }
...
const _sfc_main = /* @__PURE__ */ vueExports.defineComponent({
  ...
  setup(__props) {
    const title = vueExports.ref("Nuxt 3 + NaiveUI Starter");
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent_1(vueExports.unref(NSpace), vueExports.mergeProps({
        vertical: "",
        size: "large"
      }, _attrs), {
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent_1(vueExports.unref(NText), { type: "primary" }, {
              default: vueExports.withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate_1(vueExports.unref(title))}`);
                } else {
                  return [
                    vueExports.createTextVNode(vueExports.toDisplayString(vueExports.unref(title)), 1)
                  ];
                }
              }),
              _: 1
            }, _parent2, _scopeId));
            _push2(ssrRenderComponent_1(vueExports.unref(Button), null, {
              default: vueExports.withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`aaa`);
                } else {
                  return [
                    vueExports.createTextVNode("aaa")
                  ];
                }
              }),
              _: 1
            ...
            return [
              vueExports.createVNode(vueExports.unref(NText), { type: "primary" }, {
                default: vueExports.withCtx(() => [
                  vueExports.createTextVNode(vueExports.toDisplayString(vueExports.unref(title)), 1)
                ]),
                _: 1
              }),
              vueExports.createVNode(vueExports.unref(Button), null, {
                default: vueExports.withCtx(() => [
                  vueExports.createTextVNode("aaa")
                ]),
                _: 1
...
//# sourceMappingURL=index-BUMF-1dG.mjs.map
